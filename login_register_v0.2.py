...
password_entry = None
login_button = None
clickForRegisterLabel = None
clickForRegister = None
...
def transitionToRegister(event):
    ...
    reg_username_entry = Entry(window).pack()
    ...
    reg_password_entry = Entry(window, show="*").pack()
    ...
    reg_password2_entry = Entry(window, show="*").pack()
